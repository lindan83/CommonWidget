...
public class EasyPickerView extends View {
    ...
    // 两端文字最小alpha值，范围0.0f~1.0f，默认0.4f
    ...
    public EasyPickerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        textSize = a.getDimensionPixelSize(R.styleable.EasyPickerView_itemTextSize, (int) TypedValue.applyDimension(
                TypedValue.COMPLEX_UNIT_SP, 16, getResources().getDisplayMetrics()));
        int textColor = a.getColor(R.styleable.EasyPickerView_itemTextColor, Color.BLACK);
        textPadding = a.getDimensionPixelSize(R.styleable.EasyPickerView_itemTextPadding, (int) TypedValue.applyDimension(
                TypedValue.COMPLEX_UNIT_DIP, 20, getResources().getDisplayMetrics()));
        textMaxScale = a.getFloat(R.styleable.EasyPickerView_selectedItemTextMaxScale, 2.0f);
    ...
    public void setDataList(ArrayList<String> dataList) {
        ...
        if (size > 0) {
            for (int i = 0; i < size; i++) {
                float tempWidth = textPaint.measureText(this.dataList.get(i));
