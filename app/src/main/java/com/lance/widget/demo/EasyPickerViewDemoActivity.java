...
import com.lance.common.widget.EasyPickerView;

import java.util.ArrayList;

public class EasyPickerViewDemoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_easy_picker_view_demo);
    ...
    private void initHours() {
        ...
        for (int i = 0; i < 24; i++)
            hDataList.add(String.valueOf(i));
